...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperTestCategory {
    ...
    public class AutomadomewrapperTrigger : SequenceTrigger {
        /// <summary>
        ...
        public AutomadomewrapperTrigger() {
        }

        public override object Clone() {
            return new AutomadomewrapperTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AutomadomewrapperTrigger)}";
        }
    }
}