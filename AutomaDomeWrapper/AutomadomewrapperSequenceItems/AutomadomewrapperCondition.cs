...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperTestCategory {
    ...
    public class AutomadomewrapperCondition : SequenceCondition {
        /// <summary>
        ...
        public AutomadomewrapperCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new AutomadomewrapperCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AutomadomewrapperCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}