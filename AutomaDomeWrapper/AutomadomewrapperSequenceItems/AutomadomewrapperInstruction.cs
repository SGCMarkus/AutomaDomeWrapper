...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "AutomaDomeWrapper")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class AutomadomewrapperInstruction : SequenceItem {
        /// <summary>
        ...
        public AutomadomewrapperInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public AutomadomewrapperInstruction(AutomadomewrapperInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new AutomadomewrapperInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(AutomadomewrapperInstruction)}, Text: {Text}";
        }
    }
}