...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperDrivers {
    ...
    /// </summary>
    public class AutomadomewrapperWeatherDriver : BaseINPC, IWeatherData {
        public AutomadomewrapperWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Automadomewrapper Weather Data ({deviceId})";
        ...
        public string Category => "Automadomewrapper Weather Driver";
