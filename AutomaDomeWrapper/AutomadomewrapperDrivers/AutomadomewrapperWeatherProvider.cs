...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperDrivers {
    /// <summary>
    ...
    public class AutomadomewrapperWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public AutomadomewrapperWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "Automadomewrapper";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new AutomadomewrapperWeatherDriver("MyUniqueId", "MyDeviceId"));
