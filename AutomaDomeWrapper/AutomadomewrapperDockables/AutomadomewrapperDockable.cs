...
namespace MarkusOrnik.NINA.Automadomewrapper.AutomadomewrapperDockables {
    ...
    public class AutomadomewrapperDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public AutomadomewrapperDockable(
            ...
            dict.Source = new Uri("MarkusOrnik.NINA.Automadomewrapper;component/AutomadomewrapperDockables/AutomadomewrapperDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["MarkusOrnik.NINA.Automadomewrapper_AltitudeSVG"];
